        ...
        if nums == []:
            ...
            for i in range(len(nums)+1):
                ...
                for j in range(i+1, len(nums)+1):
                    ...
                    if self.sum(nums[i:j]) > result:
                        result = self.sum(nums[i:j])
